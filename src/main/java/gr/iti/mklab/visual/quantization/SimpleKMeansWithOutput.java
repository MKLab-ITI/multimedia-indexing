 ...
 */
public class SimpleKMeansWithOutput extends RandomizableClusterer implements NumberOfClustersRequestable,
	...
	protected boolean launchAssignToClusters(Instances insts, int[] clusterAssignments) throws Exception {
		...
		for (int i = 0; i < m_executionSlots; i++) {
			...
			Future<Boolean> futureKM = m_executorPool.submit(new KMeansClusterTask(insts, start, end,
					clusterAssignments));
	...
	public int clusterInstance(Instance instance) throws Exception {
		...
		return clusterProcessedInstance(inst, true, true);
	}
	...
	public static void main(String[] args) {
		runClusterer(new SimpleKMeansWithOutput(), args);
	}
}
